...
# BUG FIX: graph was incomplete — added all nodes and their neighbours
# derived from the weights dictionary
...
# 3. Heuristic values = traffic per city (goal = Coligny has h=0)
# BUG FIX: heuristic dictionary was completely empty
...
# 6. Run
# BUG FIX: goal was set to " " (a space) — corrected to "Coligny"
